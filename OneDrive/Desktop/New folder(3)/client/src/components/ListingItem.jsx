...
export const ListingItem=({listing})=>{
    ...
    return <div>
        {listing.imageUrls &&
        <div className="rounded-lg bg-white flex flex-col gap-2 w-[320px] sm:w-[340px] shadow-md hover:shadow-lg transition-shadow overflow-hidden" onClick={()=>navigate(`/listing/${listing._id}`)}>
